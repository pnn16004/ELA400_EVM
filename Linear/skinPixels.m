...
function coloredObjectsMask = skinPixels(rgbImage, box)
...
coloredObjectsMask = uint8(bwareaopen(coloredObjectsMask, smallestAcceptableArea)); %slow
...
if ~isempty(box)
    ...
    coloredObjectsMask(1:floor(box(1,2)),1:end,:) = 0;
    coloredObjectsMask(ceil(box(1,2)+box(2,2)):end,1:end,:) = 0;
end
%-
